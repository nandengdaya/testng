...
public class MySQL {
    ...
    private static final String userName= "gqs";
    private static final String passwd = "Gqs@2018";

    private static final String IpPort ="172.26.40.18";//测试


    private static final String dbName ="Gxuantest";
    //连接数据库
    static {
        initConnection();
    }
    ...
    public static void initConnection(){
        ...
        String url = "jdbc:mysql://"+IpPort+";DataBaseName="+dbName ;
        try {
            //连接数据库
